...
@NamedQueries({
    ...
    @NamedQuery(name = "Notat.findByMesimdhenesiID", query = "SELECT n FROM Notat n WHERE n.mesimdhenesiID = :mesimdhenesiID"),
...
public class Notat implements Serializable {
    ...
    public Notat(Integer id, int lendaID, int nxenesiID, int mesimdhenesiID, int nota) {
        this.id = id;
